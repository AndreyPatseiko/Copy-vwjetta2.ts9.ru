...
<?php if ( comments_open() ) : ?>
	...
	?>
	<div class="clear"></div>
	<div class="h2"> <h3><?php echo $twc_option_TXT_comm_h2;?></h3></div>
	<div id="ccom">
...
<div>
	<div class="h2"><h3><?php echo $twc_option_TXT_comm_form_h2;?></h3></div>
...
<?php if ( $user_ID ) : ?>
	...
	<?php printf(__(''), '<a href="'.get_option('siteurl').'/wp-admin/profile.php">'.$user_identity.'</a>'); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?action=logout" title="<?php _e('Log out of this account') ?>"><?php _e('Log out &raquo;'); ?></a>
